...
function IsSpecialSong()
		if GAMESTATE:GetCurrentSong():GetDisplayFullTitle() == "Anti-Matter"									then return true
	elseif GAMESTATE:GetCurrentSong():GetDisplayFullTitle() == "New Decade"										then return true
	elseif GAMESTATE:GetCurrentSong():GetDisplayFullTitle() == "Pierce The Sky"									then return true
	elseif GAMESTATE:GetCurrentSong():GetDisplayFullTitle() == "POSSESSION"										then return true
	elseif GAMESTATE:GetCurrentSong():GetDisplayFullTitle() == "Sakura Sunrise"									then return true
	elseif GAMESTATE:GetCurrentSong():GetDisplayFullTitle() == "Shiny World"									then return true
	elseif GAMESTATE:GetCurrentSong():GetDisplayFullTitle() == "Valkyrie dimension"								then return true
	elseif GAMESTATE:GetCurrentSong():GetDisplayFullTitle() == "MAX.(period)"									then return true
	elseif GAMESTATE:GetCurrentSong():GetDisplayFullTitle() == "EGOISM 440"										then return true
	elseif GAMESTATE:GetCurrentSong():GetDisplayFullTitle() == "Over The “Period”"								then return true
	elseif GAMESTATE:GetCurrentSong():GetDisplayFullTitle() == "DDR MEGAMIX" 									then return true
	elseif GAMESTATE:GetCurrentSong():GetDisplayFullTitle() == "Yuni's Nocturnal Days" 							then return true
	else																											 return	false
	end
end

function SpecialChar()
		if GAMESTATE:GetCurrentSong():GetDisplayFullTitle() == "Anti-Matter"									then return "(X2) Rinon Blue"
	elseif GAMESTATE:GetCurrentSong():GetDisplayFullTitle() == "New Decade"										then return "(X2) Rinon Orange"
	elseif GAMESTATE:GetCurrentSong():GetDisplayFullTitle() == "Pierce The Sky"									then return "(X2) Rinon Cyan"
	elseif GAMESTATE:GetCurrentSong():GetDisplayFullTitle() == "POSSESSION"										then return "(X2) Rinon Purple"
	elseif GAMESTATE:GetCurrentSong():GetDisplayFullTitle() == "Sakura Sunrise"									then return "(X2) Rinon Green"
	elseif GAMESTATE:GetCurrentSong():GetDisplayFullTitle() == "Shiny World"									then return "(X2) Rinon Yellow"
	elseif GAMESTATE:GetCurrentSong():GetDisplayFullTitle() == "Valkyrie dimension"								then return "(X2) Rinon Dark"
	elseif GAMESTATE:GetCurrentSong():GetDisplayFullTitle() == "MAX.(period)"									then return "(X2) Rinon Dark"
	elseif GAMESTATE:GetCurrentSong():GetDisplayFullTitle() == "EGOISM 440"										then return "(X2) Rinon"
	elseif GAMESTATE:GetCurrentSong():GetDisplayFullTitle() == "Over The “Period”"								then return "(X2) Rinon"
	elseif GAMESTATE:GetCurrentSong():GetDisplayFullTitle() == "DDR MEGAMIX" 									then return "(1st) Afro"
	elseif GAMESTATE:GetCurrentSong():GetDisplayFullTitle() == "Yuni's Nocturnal Days" 							then return "(X2) Yuni"
	end
end

function WhichRead(pn)
	if IsSpecialSong() then
		return SpecialChar()
	else
		if GetUserPref("SelectCharacter"..pn) == "Random" then
...
function DSLoader()
	...
	local DanceStage = DanceStageSong()
