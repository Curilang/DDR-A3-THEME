...
return Def.ActorFrame{
	...
	Def.Sprite{
		Texture=THEME:GetPathB("","_door/light_blue"),
		InitCommand=function(s) s:xy(_screen.cx-5,-10):diffusealpha(0):zoom(0.667) end,
		OnCommand=function(s) s:sleep(AnimationSleep):linear(0.85):diffusealpha(1):linear(0.8):diffusealpha(0.65):linear(0.85):diffusealpha(1) end,
	};
	Def.Sprite{
