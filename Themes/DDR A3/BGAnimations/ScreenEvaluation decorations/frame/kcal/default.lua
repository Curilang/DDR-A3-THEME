...
t[#t+1] = LoadActor(Language().."kcal_base");
...
t[#t+1] = Def.Sprite{
		...
		if CaloriesToday >= 0 and CaloriesToday <= 5 then
			self:Load(THEME:GetPathB("ScreenEvaluation", "decorations/frame/kcal/"..Language().."kcal_00"));
		elseif CaloriesToday >= 5.01 and CaloriesToday <= 30 then
			self:Load(THEME:GetPathB("ScreenEvaluation", "decorations/frame/kcal/"..Language().."kcal_01"));
		elseif CaloriesToday >= 30.01 and CaloriesToday <= 50 then
			self:Load(THEME:GetPathB("ScreenEvaluation", "decorations/frame/kcal/"..Language().."kcal_02"));
		elseif CaloriesToday >= 50.01 and CaloriesToday <= 60 then
			self:Load(THEME:GetPathB("ScreenEvaluation", "decorations/frame/kcal/"..Language().."kcal_03"));
		elseif CaloriesToday >= 60.01 and CaloriesToday <= 70 then
			self:Load(THEME:GetPathB("ScreenEvaluation", "decorations/frame/kcal/"..Language().."kcal_04"));
		elseif CaloriesToday >= 70.01 and CaloriesToday <= 85 then
			self:Load(THEME:GetPathB("ScreenEvaluation", "decorations/frame/kcal/"..Language().."kcal_05"));
		elseif CaloriesToday >= 85.01 and CaloriesToday <= 100 then
			self:Load(THEME:GetPathB("ScreenEvaluation", "decorations/frame/kcal/"..Language().."kcal_06"));
		elseif CaloriesToday >= 100.01 and CaloriesToday <= 120 then
			self:Load(THEME:GetPathB("ScreenEvaluation", "decorations/frame/kcal/"..Language().."kcal_07"));
		elseif CaloriesToday >= 120.01 and CaloriesToday <= 150 then
			self:Load(THEME:GetPathB("ScreenEvaluation", "decorations/frame/kcal/"..Language().."kcal_08"));
		elseif CaloriesToday >= 150.01 and CaloriesToday <= 200 then
			self:Load(THEME:GetPathB("ScreenEvaluation", "decorations/frame/kcal/"..Language().."kcal_09"));
		elseif CaloriesToday >= 200.01 and CaloriesToday <= 220 then
			self:Load(THEME:GetPathB("ScreenEvaluation", "decorations/frame/kcal/"..Language().."kcal_10"));
		elseif CaloriesToday >= 220.01 and CaloriesToday <= 235 then
			self:Load(THEME:GetPathB("ScreenEvaluation", "decorations/frame/kcal/"..Language().."kcal_11"));
		elseif CaloriesToday >= 235.01 and CaloriesToday <= 250 then
			self:Load(THEME:GetPathB("ScreenEvaluation", "decorations/frame/kcal/"..Language().."kcal_12"));
		elseif CaloriesToday >= 250.01 and CaloriesToday <= 280 then
			self:Load(THEME:GetPathB("ScreenEvaluation", "decorations/frame/kcal/"..Language().."kcal_13"));
		elseif CaloriesToday >= 280.01 and CaloriesToday <= 300 then
			self:Load(THEME:GetPathB("ScreenEvaluation", "decorations/frame/kcal/"..Language().."kcal_14"));
		elseif CaloriesToday >= 300.01 and CaloriesToday <= 330 then
			self:Load(THEME:GetPathB("ScreenEvaluation", "decorations/frame/kcal/"..Language().."kcal_15"));
		elseif CaloriesToday >= 330.01 and CaloriesToday <= 355 then
			self:Load(THEME:GetPathB("ScreenEvaluation", "decorations/frame/kcal/"..Language().."kcal_16"));
		elseif CaloriesToday >= 355.01 and CaloriesToday <= 400 then
			self:Load(THEME:GetPathB("ScreenEvaluation", "decorations/frame/kcal/"..Language().."kcal_17"));
		elseif CaloriesToday >= 400.01 and CaloriesToday <= 430 then
			self:Load(THEME:GetPathB("ScreenEvaluation", "decorations/frame/kcal/"..Language().."kcal_18"));
		elseif CaloriesToday >= 430.01 and CaloriesToday <= 450 then
			self:Load(THEME:GetPathB("ScreenEvaluation", "decorations/frame/kcal/"..Language().."kcal_19"));
		elseif CaloriesToday >= 450.01 and CaloriesToday <= 505 then
			self:Load(THEME:GetPathB("ScreenEvaluation", "decorations/frame/kcal/"..Language().."kcal_20"));
		elseif CaloriesToday >= 505.01 and CaloriesToday <= 550 then
			self:Load(THEME:GetPathB("ScreenEvaluation", "decorations/frame/kcal/"..Language().."kcal_21"));
		elseif CaloriesToday >= 550.01 and CaloriesToday <= 570 then
			self:Load(THEME:GetPathB("ScreenEvaluation", "decorations/frame/kcal/"..Language().."kcal_22"));
		elseif CaloriesToday >= 570.01 and CaloriesToday <= 600 then
			self:Load(THEME:GetPathB("ScreenEvaluation", "decorations/frame/kcal/"..Language().."kcal_23"));
		elseif CaloriesToday >= 600.01 and CaloriesToday <= 620 then
			self:Load(THEME:GetPathB("ScreenEvaluation", "decorations/frame/kcal/"..Language().."kcal_24"));
		elseif CaloriesToday >= 620.01 and CaloriesToday <= 700 then
			self:Load(THEME:GetPathB("ScreenEvaluation", "decorations/frame/kcal/"..Language().."kcal_25"));
		elseif CaloriesToday >= 700.01 and CaloriesToday <= 740 then
			self:Load(THEME:GetPathB("ScreenEvaluation", "decorations/frame/kcal/"..Language().."kcal_26"));
		elseif CaloriesToday >= 740.01 and CaloriesToday <= 870 then
			self:Load(THEME:GetPathB("ScreenEvaluation", "decorations/frame/kcal/"..Language().."kcal_27"));
		elseif CaloriesToday >= 870.01 and CaloriesToday <= 900 then
			self:Load(THEME:GetPathB("ScreenEvaluation", "decorations/frame/kcal/"..Language().."kcal_28"));			
