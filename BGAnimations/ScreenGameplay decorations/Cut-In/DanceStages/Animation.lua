...
local charComboA   = "/Characters/"..GetCharacter(pn).."/Cut-In/comboA.png";
local charComboB   = "/Characters/"..GetCharacter(pn).."/Cut-In/comboB.png";
local charCombo100 = "/Characters/"..GetCharacter(pn).."/Cut-In/combo100.png";
local charCircles  = "/Characters/"..GetCharacter(pn).."/Cut-In/Tex_0035.png";
local charColor    = "/Characters/"..GetCharacter(pn).."/Cut-In/Tex_0036.png";
local charLight    = "/Characters/"..GetCharacter(pn).."/Cut-In/Tex_0037.png";
