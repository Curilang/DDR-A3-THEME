return Def.ActorFrame{
	...
	InitCommand=function(s) s:xy(_screen.cx+362,_screen.cy+20) end,
		LoadActor(THEME:GetPathG("","_shared/infomiddle"))..{
			...
			LoseFocusCommand=function(s) setenv("SelSing",0) s:queuecommand("Off") end,
			OffCommand=function(s) s:stoptweening():smooth(0.2):zoomy(0):diffusealpha(0) end,
		};
		Def.ActorFrame{
			InitCommand=function(s) s:diffusealpha(0) end,
			OnCommand=function(s) s:sleep(0.6):queuecommand("Anim") end,
			...
			LoadActor(THEME:GetPathG("ScreenSelectStyle","Icon/Single/"..Language().."text"));
			LoadActor(THEME:GetPathG("ScreenSelectStyle","Icon/Single/"..Model().."pad"))..{
