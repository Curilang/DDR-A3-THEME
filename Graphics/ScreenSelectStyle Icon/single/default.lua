...
t[#t+1] = Def.ActorFrame{
  ...
  Def.ActorFrame{
    LoadActor(THEME:GetPathG("ScreenSelectStyle","icon/infomiddle"))..{
      OnCommand=cmd(diffusealpha,0;zoomy,0;sleep,0.5;smooth,0.2;zoomy,1.5;diffusealpha,1;smooth,0.1;zoomy,1.1);
  ...
  LoadActor(THEME:GetPathG("ScreenSelectStyle","icon/"..Model().."bottom"))..{
    ...
    OnCommand=cmd(diffusealpha,0;y,0;sleep,0.5;smooth,0.2;y,100;diffusealpha,1;smooth,0.1;y,88);
    OffCommand=cmd(smooth,0.2;y,0;diffusealpha,0);
